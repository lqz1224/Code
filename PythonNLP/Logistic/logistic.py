...
def load_data_set():
    ...
    data_arr = []
    label_arr = []
    f = open('/Users/liuquanzhen/Documents/Code/PythonNLP/Logistic/data/TestSet.txt', 'r')
...
def colic_test():
    ...
    :return: 
    """
    f_train = open('/Users/liuquanzhen/Documents/Code/PythonNLP/Logistic/data/HorseColicTraining.txt', 'r')
    f_test = open('/Users/liuquanzhen/Documents/Code/PythonNLP/Logistic/data/HorseColicTest.txt', 'r')
    training_set = []
    training_labels = []
