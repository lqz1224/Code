...
def testRbf(k1=1.3):
    dataArr, labelArr = loadDataSet('/Users/liuquanzhen/Documents/Code/PythonNLP/SVM/data/testSetRBF.txt')
    ...
    dataArr, labelArr = loadDataSet('/Users/liuquanzhen/Documents/Code/PythonNLP/SVM/data/testSetRBF2.txt')
    errorCount = 0
    datMat = mat(dataArr)
    labelMat = mat(labelArr).transpose()
    m, n = shape(datMat)
...
def testDigits(kTup=('rbf', 10)):
    ...
    # 1. 导入训练数据
    dataArr, labelArr = loadImages('/Users/liuquanzhen/Documents/Code/PythonNLP/SVM/data/trainingDigits')
    ...
    print("the training error rate is: %f" % (float(errorCount) / m))
    # 2. 导入测试数据
    dataArr, labelArr = loadImages('/Users/liuquanzhen/Documents/Code/PythonNLP/SVM/data/testDigits')
    errorCount = 0
    datMat = mat(dataArr)
    labelMat = mat(labelArr).transpose()
    m, n = shape(datMat)
