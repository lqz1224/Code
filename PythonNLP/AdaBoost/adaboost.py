...
def test():
    ...
    data_mat, class_labels = load_data_set(path+"/AdaBoost/data/horseColicTraining2.txt")
    ...
    data_arr_test, label_arr_test = load_data_set(path+"/AdaBoost/data/horseColicTest2.txt")
